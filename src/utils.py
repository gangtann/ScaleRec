...
def parse_args():
    ...
    parser.add_argument("--scales", default=[50, 25], type=int, nargs='+', help="List of scales")
    parser.add_argument("--kernels", default=[4, 8, 12], type=int, nargs='+', help="List of kernels")
    parser.add_argument("--start_prob", default=0.2, type=float)
    parser.add_argument("--end_prob", default=0.5, type=float)
